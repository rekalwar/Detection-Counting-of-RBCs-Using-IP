...
#     input_image = models.FileField(null=True)
...
class Search_Data(models.Model):
    ...
    input_image = models.FileField(null=True)
    output_image = models.FileField(null=True)
    output_image1 = models.FileField(null=True)
    output_image2 = models.FileField(null=True)
    output_image3 = models.FileField(null=True)
    output_image4 = models.FileField(null=True)
    output_image5 = models.FileField(null=True)
    output_image6 = models.FileField(null=True)
    output_image7 = models.FileField(null=True)
    output_image8 = models.FileField(null=True)
    created = models.DateTimeField(auto_now=True,null=True)

    def __str__(self):
        return self.patient.user.username
    
class Cell_Count_Search_Data(models.Model):
    patient = models.ForeignKey(Patient, on_delete=models.CASCADE, null=True)
    prediction_accuracy = models.CharField(max_length=100,null=True,blank=True)
    result = models.CharField(max_length=100,null=True,blank=True)
    values_list = models.CharField(max_length=100,null=True,blank=True)
