...
urlpatterns = [
    path('admin/', admin.site.urls),
                  ...
                  path('age_detection', age_detection, name="age_detection"),
                  path('leukemia_detection', leukemia_detection, name="leukemia_detection"),
                  path('count_blood_cells_detection', count_blood_cells_detection, name="count_blood_cells_detection"),
                  path('view_search_cellcount', view_search_cellcount, name="view_search_cellcount"),
                  path('delete_cell_searched/<int:pid>', delete_cell_searched, name="delete_cell_searched")
